...
import { getAllCotization, getCotizationsOverview, getOpenCotization, removeCotization } from "../../services/cotizationService";
...
const OpenCotizations = () =>{
  ...
  const {data: sourceData, isSuccess, isFetching, refetch} = useQuery<cotizationGeneralData[]>({queryKey: ["getOpenCotization"], queryFn: getOpenCotization, refetchOnWindowFocus: false});
...
export default OpenCotizations;
